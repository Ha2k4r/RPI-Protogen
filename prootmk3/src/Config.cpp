...
void init(std::vector<Expression>& faces){
  ...
  faces[0].ColorMap.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="BluePink", .wait_time=0.041, .ExpressionType=1, .MediaPath="color_maps/WHOH1.gif"});
    //blush face
  ...
  faces[2].ColorMap.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="BluePink", .wait_time=0.041, .ExpressionType=1, .MediaPath="color_maps/WHOH1.gif"});
}