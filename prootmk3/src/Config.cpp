...
void init(std::vector<Expression>& faces){
  //happy face
  faces[0].Sprites.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="Eyeball", .wait_time=10, .MainChords=EyeHappyArray, .OposingChords=EyeClosedHappyArray , .ExpressionType=1, .wait_time2=0.01});
  faces[0].Sprites.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="HappyNose", .MainChords=NoseHappyArray});
  faces[0].Sprites.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="MouthButHappy", .MainChords=MouthHappyArray});
  faces[0].ColorMap.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="BlueePink", .wait_time=0.041, .ExpressionType=1, .MediaPath="color_maps/WHOH1.gif"});
 
  //blush face
  faces[1].Sprites.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="Nose", .MainChords=NoseHappyArray});
  faces[1].Sprites.emplace_back(Expression_Params{.UNIQUE_IDENTIFYER="blushyMouth", .MainChords=MouthHappyArray});
